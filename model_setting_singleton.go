...
type SettingSingleton struct {
	...
	INSTALL_UUID string `json:"INSTALL_UUID,omitempty"`
	DEFAULT_CONTROL_PLANE_QUEUE_NAME string `json:"DEFAULT_CONTROL_PLANE_QUEUE_NAME,omitempty"`
	DEFAULT_EXECUTION_QUEUE_NAME string `json:"DEFAULT_EXECUTION_QUEUE_NAME,omitempty"`
	...
	AWX_TASK_ENV map[string]string `json:"AWX_TASK_ENV,omitempty"`
	...
	AWXMOUNTISOLATEDPATHSONK8S bool `json:"AWX_MOUNT_ISOLATED_PATHS_ON_K8S,omitempty"`
	...
	DEFAULT_JOB_IDLE_TIMEOUT int32 `json:"DEFAULT_JOB_IDLE_TIMEOUT,omitempty"`
	...
	API400ERRORLOGFORMAT string `json:"API_400_ERROR_LOG_FORMAT,omitempty"`
	AUTOMATION_ANALYTICS_LAST_GATHER time.Time `json:"AUTOMATION_ANALYTICS_LAST_GATHER"`
	...
	OAUTH2PROVIDER map[string]int32 `json:"OAUTH2_PROVIDER,omitempty"`
	...
	PENDO_TRACKING_STATE string `json:"PENDO_TRACKING_STATE,omitempty"`
	...
	AUTHENTICATION_BACKENDS []string `json:"AUTHENTICATION_BACKENDS,omitempty"`
	...
	SOCIAL_AUTH_ORGANIZATION_MAP map[string]map[string]string `json:"SOCIAL_AUTH_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIAL_AUTH_TEAM_MAP map[string]map[string]string `json:"SOCIAL_AUTH_TEAM_MAP,omitempty"`
	...
	AUTH_LDAP_CONNECTION_OPTIONS map[string]string `json:"AUTH_LDAP_CONNECTION_OPTIONS,omitempty"`
	...
	AUTH_LDAP_USER_ATTR_MAP map[string]string `json:"AUTH_LDAP_USER_ATTR_MAP,omitempty"`
	...
	AUTH_LDAP_GROUP_TYPE_PARAMS map[string]string `json:"AUTH_LDAP_GROUP_TYPE_PARAMS,omitempty"`
	...
	AUTH_LDAP_USER_FLAGS_BY_GROUP map[string][]string `json:"AUTH_LDAP_USER_FLAGS_BY_GROUP,omitempty"`
	...
	AUTH_LDAP_ORGANIZATION_MAP map[string]map[string]string `json:"AUTH_LDAP_ORGANIZATION_MAP,omitempty"`
	// Mapping between team members (users) and LDAP groups. Configuration details are available in the documentation.
	AUTH_LDAP_TEAM_MAP map[string]map[string]string `json:"AUTH_LDAP_TEAM_MAP,omitempty"`
	// URI to connect to LDAP server, such as \"ldap://ldap.example.com:389\" (non-SSL) or \"ldaps://ldap.example.com:636\" (SSL). Multiple LDAP servers may be specified by separating with spaces or commas. LDAP authentication is disabled if this parameter is empty.
	...
	// Additional options to set for the LDAP connection.  LDAP referrals are disabled by default (to prevent certain LDAP queries from hanging with AD). Option names should be strings (e.g. \"OPT_REFERRALS\"). Refer to https://www.python-ldap.org/doc/html/ldap.html#options for possible options and values that can be set.
	AUTHLDAP1CONNECTIONOPTIONS map[string]string `json:"AUTH_LDAP_1_CONNECTION_OPTIONS,omitempty"`
	// LDAP search query to find users.  Any user that matches the given pattern will be able to login to the service.  The user should also be mapped into an organization (as defined in the AUTH_LDAP_ORGANIZATION_MAP setting).  If multiple search queries need to be supported use of \"LDAPUnion\" is possible. See the documentation for details.
	...
	// Mapping of LDAP user schema to API user attributes. The default setting is valid for ActiveDirectory but users with other LDAP configurations may need to change the values. Refer to the documentation for additional details.
	AUTHLDAP1USERATTRMAP map[string]string `json:"AUTH_LDAP_1_USER_ATTR_MAP,omitempty"`
	// Users are mapped to organizations based on their membership in LDAP groups. This setting defines the LDAP search query to find groups. Unlike the user search, group search does not support LDAPSearchUnion.
	...
	// Key value parameters to send the chosen group type init method.
	AUTHLDAP1GROUPTYPEPARAMS map[string]string `json:"AUTH_LDAP_1_GROUP_TYPE_PARAMS,omitempty"`
	// Group DN required to login. If specified, user must be a member of this group to login via LDAP. If not set, everyone in LDAP that matches the user search will be able to login to the service. Only one require group is supported.
	...
	// Retrieve users from a given group. At this time, superuser and system auditors are the only groups supported. Refer to the documentation for more detail.
	AUTHLDAP1USERFLAGSBYGROUP map[string][]string `json:"AUTH_LDAP_1_USER_FLAGS_BY_GROUP,omitempty"`
	// Mapping between organization admins/users and LDAP groups. This controls which users are placed into which organizations relative to their LDAP group memberships. Configuration details are available in the documentation.
	AUTHLDAP1ORGANIZATIONMAP map[string]map[string]string `json:"AUTH_LDAP_1_ORGANIZATION_MAP,omitempty"`
	// Mapping between team members (users) and LDAP groups. Configuration details are available in the documentation.
	AUTHLDAP1TEAMMAP map[string]map[string]string `json:"AUTH_LDAP_1_TEAM_MAP,omitempty"`
	// URI to connect to LDAP server, such as \"ldap://ldap.example.com:389\" (non-SSL) or \"ldaps://ldap.example.com:636\" (SSL). Multiple LDAP servers may be specified by separating with spaces or commas. LDAP authentication is disabled if this parameter is empty.
	...
	// Additional options to set for the LDAP connection.  LDAP referrals are disabled by default (to prevent certain LDAP queries from hanging with AD). Option names should be strings (e.g. \"OPT_REFERRALS\"). Refer to https://www.python-ldap.org/doc/html/ldap.html#options for possible options and values that can be set.
	AUTHLDAP2CONNECTIONOPTIONS map[string]string `json:"AUTH_LDAP_2_CONNECTION_OPTIONS,omitempty"`
	// LDAP search query to find users.  Any user that matches the given pattern will be able to login to the service.  The user should also be mapped into an organization (as defined in the AUTH_LDAP_ORGANIZATION_MAP setting).  If multiple search queries need to be supported use of \"LDAPUnion\" is possible. See the documentation for details.
	...
	// Mapping of LDAP user schema to API user attributes. The default setting is valid for ActiveDirectory but users with other LDAP configurations may need to change the values. Refer to the documentation for additional details.
	AUTHLDAP2USERATTRMAP map[string]string `json:"AUTH_LDAP_2_USER_ATTR_MAP,omitempty"`
	// Users are mapped to organizations based on their membership in LDAP groups. This setting defines the LDAP search query to find groups. Unlike the user search, group search does not support LDAPSearchUnion.
	...
	// Key value parameters to send the chosen group type init method.
	AUTHLDAP2GROUPTYPEPARAMS map[string]string `json:"AUTH_LDAP_2_GROUP_TYPE_PARAMS,omitempty"`
	// Group DN required to login. If specified, user must be a member of this group to login via LDAP. If not set, everyone in LDAP that matches the user search will be able to login to the service. Only one require group is supported.
	...
	// Retrieve users from a given group. At this time, superuser and system auditors are the only groups supported. Refer to the documentation for more detail.
	AUTHLDAP2USERFLAGSBYGROUP map[string][]string `json:"AUTH_LDAP_2_USER_FLAGS_BY_GROUP,omitempty"`
	// Mapping between organization admins/users and LDAP groups. This controls which users are placed into which organizations relative to their LDAP group memberships. Configuration details are available in the documentation.
	AUTHLDAP2ORGANIZATIONMAP map[string]map[string]string `json:"AUTH_LDAP_2_ORGANIZATION_MAP,omitempty"`
	// Mapping between team members (users) and LDAP groups. Configuration details are available in the documentation.
	AUTHLDAP2TEAMMAP map[string]map[string]string `json:"AUTH_LDAP_2_TEAM_MAP,omitempty"`
	// URI to connect to LDAP server, such as \"ldap://ldap.example.com:389\" (non-SSL) or \"ldaps://ldap.example.com:636\" (SSL). Multiple LDAP servers may be specified by separating with spaces or commas. LDAP authentication is disabled if this parameter is empty.
	...
	// Additional options to set for the LDAP connection.  LDAP referrals are disabled by default (to prevent certain LDAP queries from hanging with AD). Option names should be strings (e.g. \"OPT_REFERRALS\"). Refer to https://www.python-ldap.org/doc/html/ldap.html#options for possible options and values that can be set.
	AUTHLDAP3CONNECTIONOPTIONS map[string]string `json:"AUTH_LDAP_3_CONNECTION_OPTIONS,omitempty"`
	// LDAP search query to find users.  Any user that matches the given pattern will be able to login to the service.  The user should also be mapped into an organization (as defined in the AUTH_LDAP_ORGANIZATION_MAP setting).  If multiple search queries need to be supported use of \"LDAPUnion\" is possible. See the documentation for details.
	...
	// Mapping of LDAP user schema to API user attributes. The default setting is valid for ActiveDirectory but users with other LDAP configurations may need to change the values. Refer to the documentation for additional details.
	AUTHLDAP3USERATTRMAP map[string]string `json:"AUTH_LDAP_3_USER_ATTR_MAP,omitempty"`
	// Users are mapped to organizations based on their membership in LDAP groups. This setting defines the LDAP search query to find groups. Unlike the user search, group search does not support LDAPSearchUnion.
	...
	// Key value parameters to send the chosen group type init method.
	AUTHLDAP3GROUPTYPEPARAMS map[string]string `json:"AUTH_LDAP_3_GROUP_TYPE_PARAMS,omitempty"`
	// Group DN required to login. If specified, user must be a member of this group to login via LDAP. If not set, everyone in LDAP that matches the user search will be able to login to the service. Only one require group is supported.
	...
	// Retrieve users from a given group. At this time, superuser and system auditors are the only groups supported. Refer to the documentation for more detail.
	AUTHLDAP3USERFLAGSBYGROUP map[string][]string `json:"AUTH_LDAP_3_USER_FLAGS_BY_GROUP,omitempty"`
	// Mapping between organization admins/users and LDAP groups. This controls which users are placed into which organizations relative to their LDAP group memberships. Configuration details are available in the documentation.
	AUTHLDAP3ORGANIZATIONMAP map[string]map[string]string `json:"AUTH_LDAP_3_ORGANIZATION_MAP,omitempty"`
	// Mapping between team members (users) and LDAP groups. Configuration details are available in the documentation.
	AUTHLDAP3TEAMMAP map[string]map[string]string `json:"AUTH_LDAP_3_TEAM_MAP,omitempty"`
	// URI to connect to LDAP server, such as \"ldap://ldap.example.com:389\" (non-SSL) or \"ldaps://ldap.example.com:636\" (SSL). Multiple LDAP servers may be specified by separating with spaces or commas. LDAP authentication is disabled if this parameter is empty.
	...
	// Additional options to set for the LDAP connection.  LDAP referrals are disabled by default (to prevent certain LDAP queries from hanging with AD). Option names should be strings (e.g. \"OPT_REFERRALS\"). Refer to https://www.python-ldap.org/doc/html/ldap.html#options for possible options and values that can be set.
	AUTHLDAP4CONNECTIONOPTIONS map[string]string `json:"AUTH_LDAP_4_CONNECTION_OPTIONS,omitempty"`
	// LDAP search query to find users.  Any user that matches the given pattern will be able to login to the service.  The user should also be mapped into an organization (as defined in the AUTH_LDAP_ORGANIZATION_MAP setting).  If multiple search queries need to be supported use of \"LDAPUnion\" is possible. See the documentation for details.
	...
	// Mapping of LDAP user schema to API user attributes. The default setting is valid for ActiveDirectory but users with other LDAP configurations may need to change the values. Refer to the documentation for additional details.
	AUTHLDAP4USERATTRMAP map[string]string `json:"AUTH_LDAP_4_USER_ATTR_MAP,omitempty"`
	// Users are mapped to organizations based on their membership in LDAP groups. This setting defines the LDAP search query to find groups. Unlike the user search, group search does not support LDAPSearchUnion.
	...
	// Key value parameters to send the chosen group type init method.
	AUTHLDAP4GROUPTYPEPARAMS map[string]string `json:"AUTH_LDAP_4_GROUP_TYPE_PARAMS,omitempty"`
	// Group DN required to login. If specified, user must be a member of this group to login via LDAP. If not set, everyone in LDAP that matches the user search will be able to login to the service. Only one require group is supported.
	...
	// Retrieve users from a given group. At this time, superuser and system auditors are the only groups supported. Refer to the documentation for more detail.
	AUTHLDAP4USERFLAGSBYGROUP map[string][]string `json:"AUTH_LDAP_4_USER_FLAGS_BY_GROUP,omitempty"`
	// Mapping between organization admins/users and LDAP groups. This controls which users are placed into which organizations relative to their LDAP group memberships. Configuration details are available in the documentation.
	AUTHLDAP4ORGANIZATIONMAP map[string]map[string]string `json:"AUTH_LDAP_4_ORGANIZATION_MAP,omitempty"`
	// Mapping between team members (users) and LDAP groups. Configuration details are available in the documentation.
	AUTHLDAP4TEAMMAP map[string]map[string]string `json:"AUTH_LDAP_4_TEAM_MAP,omitempty"`
	// URI to connect to LDAP server, such as \"ldap://ldap.example.com:389\" (non-SSL) or \"ldaps://ldap.example.com:636\" (SSL). Multiple LDAP servers may be specified by separating with spaces or commas. LDAP authentication is disabled if this parameter is empty.
	...
	// Additional options to set for the LDAP connection.  LDAP referrals are disabled by default (to prevent certain LDAP queries from hanging with AD). Option names should be strings (e.g. \"OPT_REFERRALS\"). Refer to https://www.python-ldap.org/doc/html/ldap.html#options for possible options and values that can be set.
	AUTHLDAP5CONNECTIONOPTIONS map[string]string `json:"AUTH_LDAP_5_CONNECTION_OPTIONS,omitempty"`
	// LDAP search query to find users.  Any user that matches the given pattern will be able to login to the service.  The user should also be mapped into an organization (as defined in the AUTH_LDAP_ORGANIZATION_MAP setting).  If multiple search queries need to be supported use of \"LDAPUnion\" is possible. See the documentation for details.
	...
	// Mapping of LDAP user schema to API user attributes. The default setting is valid for ActiveDirectory but users with other LDAP configurations may need to change the values. Refer to the documentation for additional details.
	AUTHLDAP5USERATTRMAP map[string]string `json:"AUTH_LDAP_5_USER_ATTR_MAP,omitempty"`
	// Users are mapped to organizations based on their membership in LDAP groups. This setting defines the LDAP search query to find groups. Unlike the user search, group search does not support LDAPSearchUnion.
	...
	// Key value parameters to send the chosen group type init method.
	AUTHLDAP5GROUPTYPEPARAMS map[string]string `json:"AUTH_LDAP_5_GROUP_TYPE_PARAMS,omitempty"`
	// Group DN required to login. If specified, user must be a member of this group to login via LDAP. If not set, everyone in LDAP that matches the user search will be able to login to the service. Only one require group is supported.
	...
	// Retrieve users from a given group. At this time, superuser and system auditors are the only groups supported. Refer to the documentation for more detail.
	AUTHLDAP5USERFLAGSBYGROUP map[string][]string `json:"AUTH_LDAP_5_USER_FLAGS_BY_GROUP,omitempty"`
	// Mapping between organization admins/users and LDAP groups. This controls which users are placed into which organizations relative to their LDAP group memberships. Configuration details are available in the documentation.
	AUTHLDAP5ORGANIZATIONMAP map[string]map[string]string `json:"AUTH_LDAP_5_ORGANIZATION_MAP,omitempty"`
	// Mapping between team members (users) and LDAP groups. Configuration details are available in the documentation.
	AUTHLDAP5TEAMMAP map[string]map[string]string `json:"AUTH_LDAP_5_TEAM_MAP,omitempty"`
	...
	SOCIALAUTHGOOGLEOAUTH2CALLBACKURL string `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_CALLBACK_URL,omitempty"`
	...
	SOCIALAUTHGOOGLEOAUTH2AUTHEXTRAARGUMENTS map[string]string `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_AUTH_EXTRA_ARGUMENTS,omitempty"`
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIALAUTHGOOGLEOAUTH2ORGANIZATIONMAP map[string]map[string]string `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIALAUTHGOOGLEOAUTH2TEAMMAP map[string]map[string]string `json:"SOCIAL_AUTH_GOOGLE_OAUTH2_TEAM_MAP,omitempty"`
	// Provide this URL as the callback URL for your application as part of your registration process. Refer to the documentation for more detail.
	SOCIAL_AUTH_GITHUB_CALLBACK_URL string `json:"SOCIAL_AUTH_GITHUB_CALLBACK_URL,omitempty"`
	...
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIAL_AUTH_GITHUB_ORGANIZATION_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIAL_AUTH_GITHUB_TEAM_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_TEAM_MAP,omitempty"`
	// Provide this URL as the callback URL for your application as part of your registration process. Refer to the documentation for more detail.
	SOCIAL_AUTH_GITHUB_ORG_CALLBACK_URL string `json:"SOCIAL_AUTH_GITHUB_ORG_CALLBACK_URL,omitempty"`
	...
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIAL_AUTH_GITHUB_ORG_ORGANIZATION_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ORG_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIAL_AUTH_GITHUB_ORG_TEAM_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ORG_TEAM_MAP,omitempty"`
	...
	SOCIAL_AUTH_GITHUB_TEAM_CALLBACK_URL string `json:"SOCIAL_AUTH_GITHUB_TEAM_CALLBACK_URL,omitempty"`
	// The OAuth2 key (Client ID) from your GitHub organization application.
	...
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIAL_AUTH_GITHUB_TEAM_ORGANIZATION_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_TEAM_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIAL_AUTH_GITHUB_TEAM_TEAM_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_TEAM_TEAM_MAP,omitempty"`
	// Provide this URL as the callback URL for your application as part of your registration process. Refer to the documentation for more detail.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_CALLBACK_URL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_CALLBACK_URL,omitempty"`
	...
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORGANIZATION_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_MAP,omitempty"`
	// Provide this URL as the callback URL for your application as part of your registration process. Refer to the documentation for more detail.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_CALLBACK_URL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_CALLBACK_URL,omitempty"`
	// The URL for your Github Enterprise instance, e.g.: http(s)://hostname/. Refer to Github Enterprise documentation for more details.
	...
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_ORGANIZATION_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_TEAM_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_ORG_TEAM_MAP,omitempty"`
	// Create an organization-owned application at https://github.com/organizations/<yourorg>/settings/applications and obtain an OAuth2 key (Client ID) and secret (Client Secret). Provide this URL as the callback URL for your application.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_CALLBACK_URL string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_CALLBACK_URL,omitempty"`
	// The URL for your Github Enterprise instance, e.g.: http(s)://hostname/. Refer to Github Enterprise documentation for more details.
	...
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_ORGANIZATION_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_TEAM_MAP map[string]map[string]string `json:"SOCIAL_AUTH_GITHUB_ENTERPRISE_TEAM_TEAM_MAP,omitempty"`
	// Provide this URL as the callback URL for your application as part of your registration process. Refer to the documentation for more detail. 
	SOCIALAUTHAZUREADOAUTH2CALLBACKURL string `json:"SOCIAL_AUTH_AZUREAD_OAUTH2_CALLBACK_URL,omitempty"`
	...
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIALAUTHAZUREADOAUTH2ORGANIZATIONMAP map[string]map[string]string `json:"SOCIAL_AUTH_AZUREAD_OAUTH2_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIALAUTHAZUREADOAUTH2TEAMMAP map[string]map[string]string `json:"SOCIAL_AUTH_AZUREAD_OAUTH2_TEAM_MAP,omitempty"`
	...
	SOCIAL_AUTH_SAML_CALLBACK_URL string `json:"SOCIAL_AUTH_SAML_CALLBACK_URL,omitempty"`
	// If your identity provider (IdP) allows uploading an XML metadata file, you can download one from this URL.
	SOCIAL_AUTH_SAML_METADATA_URL string `json:"SOCIAL_AUTH_SAML_METADATA_URL,omitempty"`
	...
	SOCIAL_AUTH_SAML_ORG_INFO map[string]map[string]string `json:"SOCIAL_AUTH_SAML_ORG_INFO"`
	...
	SOCIAL_AUTH_SAML_TECHNICAL_CONTACT map[string]string `json:"SOCIAL_AUTH_SAML_TECHNICAL_CONTACT"`
	...
	SOCIAL_AUTH_SAML_SUPPORT_CONTACT map[string]string `json:"SOCIAL_AUTH_SAML_SUPPORT_CONTACT"`
	// Configure the Entity ID, SSO URL and certificate for each identity provider (IdP) in use. Multiple SAML IdPs are supported. Some IdPs may provide user data using attribute names that differ from the default OIDs. Attribute names may be overridden for each IdP. Refer to the Ansible documentation for additional details and syntax.
	SOCIAL_AUTH_SAML_ENABLED_IDPS map[string]map[string]string `json:"SOCIAL_AUTH_SAML_ENABLED_IDPS,omitempty"`
	...
	SOCIAL_AUTH_SAML_SECURITY_CONFIG map[string]string `json:"SOCIAL_AUTH_SAML_SECURITY_CONFIG,omitempty"`
	// A dict of key value pairs to be passed to the underlying python-saml Service Provider configuration setting.
	SOCIAL_AUTH_SAML_SP_EXTRA map[string]string `json:"SOCIAL_AUTH_SAML_SP_EXTRA,omitempty"`
	...
	// Mapping to organization admins/users from social auth accounts. This setting controls which users are placed into which organizations based on their username and email address. Configuration details are available in the  documentation.
	SOCIAL_AUTH_SAML_ORGANIZATION_MAP map[string]map[string]string `json:"SOCIAL_AUTH_SAML_ORGANIZATION_MAP,omitempty"`
	// Mapping of team members (users) from social auth accounts. Configuration details are available in the documentation.
	SOCIAL_AUTH_SAML_TEAM_MAP map[string]map[string]string `json:"SOCIAL_AUTH_SAML_TEAM_MAP,omitempty"`
	// Used to translate user organization membership.
	SOCIAL_AUTH_SAML_ORGANIZATION_ATTR map[string]string `json:"SOCIAL_AUTH_SAML_ORGANIZATION_ATTR,omitempty"`
	// Used to translate user team membership.
	SOCIAL_AUTH_SAML_TEAM_ATTR map[string]string `json:"SOCIAL_AUTH_SAML_TEAM_ATTR,omitempty"`
	// Used to map super users and system auditors from SAML.
	SOCIAL_AUTH_SAML_USER_FLAGS_BY_ATTR map[string]string `json:"SOCIAL_AUTH_SAML_USER_FLAGS_BY_ATTR,omitempty"`
	// Read-only list of key-value pairs that shows the standard format of all available named URLs.
	NAMED_URL_FORMATS map[string]string `json:"NAMED_URL_FORMATS,omitempty"`
	...
	NAMED_URL_GRAPH_NODES map[string]string `json:"NAMED_URL_GRAPH_NODES,omitempty"`
}
